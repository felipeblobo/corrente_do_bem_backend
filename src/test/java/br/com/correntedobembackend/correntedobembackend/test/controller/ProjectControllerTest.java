...
public class ProjectControllerTest {
    ...
    public void shouldReturnProjectFindById() throws Exception {
        Project project = new Project(6, 2, "Dentista(o)",
        ...
        Mockito.when(projectRepository.findById(6)).thenReturn(Optional.of(project));
        this.mockMvc.perform(
                get("/project/{id}", 6).accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk())
